...
class TestAbstractImage:
    def test_abstract_image(self, connect, dataset):  # pylint: disable=unused-argument
    ...
    def test_abstract_images(self, connect, dataset):  # pylint: disable=unused-argument
...
class TestImageInstance:
    def test_image_instance(self, connect, dataset):  # pylint: disable=unused-argument
...
class TestAbstractSlice:
    def test_abstract_slice(self, connect, dataset):  # pylint: disable=unused-argument
...
class TestSliceInstance:
    ...
    def test_slice_instance(self, connect, dataset):  # pylint: disable=unused-argument
    ...
    def test_slices_by_image(self, connect, dataset):  # pylint: disable=unused-argument
