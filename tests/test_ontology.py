...
class TestOntology:
    def test_ontology(self, connect, dataset):  # pylint: disable=unused-argument
        name = random_string()
    ...
    def test_ontologies(self, connect, dataset):  # pylint: disable=unused-argument
...
class TestTerm:
    def test_term(self, connect, dataset):  # pylint: disable=unused-argument
        name = random_string()
    ...
    def test_terms(self, connect, dataset):  # pylint: disable=unused-argument
...
class TestRelationTerm:
    def test_relation_term(self, connect, dataset):  # pylint: disable=unused-argument
