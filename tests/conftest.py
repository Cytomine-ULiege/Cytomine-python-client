...
from cytomine.models.user import Group, User
...
@pytest.fixture(scope="session")
def dataset(request):  # pylint: disable=unused-argument
    data = {}
    data["user"] = User(
        random_string(),
        random_string(),
    ...
    data["software_parameter"] = SoftwareParameter(
        random_string(),
        "Number",
        data["software"].id,
        0,
    ...
    def teardown():  # pylint: disable=unused-variable
