...
def generic_image_dump(
    ...
    **parameters,
    ...
    url_fn: callable
        ...
        The function call would be like the following:
            url_fn(model, file_path, **parameters)
        where model is the cytomine model, file_path is the destination filepath
        and parameters are the dump parameters.
    override: bool
